...
import 'package:prelude_to_bloc/disposer.dart';
import 'package:prelude_to_bloc/reactive_resource.dart';
import 'package:prelude_to_bloc/typedefs.dart';
...
class Reactive<D> with ReactiveResource implements StreamController<D> {
  ...
  @override
  int get hashCode => _onDispose.hashCode;
  ...
  set onCancel(FutureOrVoidCallback? onCancelHandler) {
    ...
    for (final controller in _controllers) {
      controller.onCancel = () => _handleOnCancelThenRemoveController(
            _onCancel,
            controller,
          );
    }
  ...
  bool operator ==(Object other) {
    ...
    return other is Reactive<D> && other._onDispose == _onDispose;
  }

  

  @override
  String toString() => 'Reactive(_onDispose: $_onDispose)';
  ...
  Future<void> _handleOnCancelThenRemoveController(
      ...
      MultiStreamController<dynamic> controller,) async {
